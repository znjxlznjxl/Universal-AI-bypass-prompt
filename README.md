...
* I recommand you to use prompt1.txt (short one) however, if the prompt won't work, go to new chat, and put prompt again. (You don't have to delete the past failed chat history) (deepseek maybe? but for me, worked well)
---

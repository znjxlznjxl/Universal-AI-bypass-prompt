...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Gemini 3.5 Flash** | 🔒 Secured | 🔒 Secured | ⚠️ Partial | **Not Recommended** | promptA.txt |
| **Gemini 3.1 Flash lite** (Minimal-High) (Ai studio & official app) | 🔓 Bypass | 🔓 Bypass | 🔓 Bypass | **Bypassed** | promptA.txt |
| **DeepSeek (DeepThink) (official app & site)** | 🔓 Bypass | 🔓 Bypass | 🔓 Bypass | **Bypassed** | prompt1.txt |
| **Manus 1.6 lite (official app)** | 🔓 Bypass | 🔓 Bypass | 🔓 Bypass | **Bypassed** | promptA.txt |
| **Owl Alpha** | 🔓 Bypass | 🔓 Bypass | 🔓 Bypass | **Bypassed** | prompt1.txt |
| **Mistral 'Work' (vibe app)** | 🔓 Bypass | 🔓 Bypass | 🔓 Bypass | **Bypassed** | promptA.txt |
...
* I recommand you to use prompt1.txt (short one) for light model. But i recommand you to use gemini.txt for gemini 3.5 flash lite
---
